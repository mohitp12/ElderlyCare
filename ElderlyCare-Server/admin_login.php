...
if (mysql_num_rows($res)== 1) {
    ...
    header("Refresh:0 ; url=home_a.php");
    exit();
}
else {
    ...
    <body>
        ...
        <div class="login-container lightmode">
            ...
            <div class="login-box animated fadeInDown">
                    <div class="login-title" style="text-align:center; font-size:30px;"><strong style=" text-transform:uppercase;">Admin</strong> login</div>
                    <div style="height:25px;">
                    	&nbsp;
                    </div>
                <div class="login-body">
                    <div class="login-title"><strong>Log In</strong> to your account</div>
                    <form action="admin_login.php" class="form-horizontal" method="post">
